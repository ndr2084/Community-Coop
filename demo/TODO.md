...
- [ ] Understand OAuth2UserService — learn how DefaultOAuth2UserService loads profile info from the provider, how to wrap it to customize authorities/roles, and how userInfoEndpoint wires it into the login flow
