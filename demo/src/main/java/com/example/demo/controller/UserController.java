...
class UserController {
    ...
    public ResponseEntity<?> createUser(@AuthenticationPrincipal OidcUser oidcUser) {
        ...
        if (
            ...
            record SignUpFormAutoFill(String name, String familyName, String picture, String email) {
            }
        ...
        record userIndex(String name, String familyName, String picture) {}
        ...
        return ResponseEntity
                ...
                .body(new userIndex(name, familyName, picture));
    }
